...
add_action('wcgs_before_sync_wrapper', 'wcgs_admin_render_sync_widget');

function wcgs_admin_render_sync_widget() {
    wcgs_load_template_file('admin/google-sheet-settings.php', ['google_client'=>null]);
}
...
function wcgs_settings_tab(){
    ...
    do_action('wcgs_before_sync_wrapper');
